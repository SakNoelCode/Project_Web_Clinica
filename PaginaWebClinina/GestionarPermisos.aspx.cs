            ...
            if (txtDNI.Text.Length == 8)
            {
                ...
                if (objEmpleado != null)
                {
                    if (objEmpleado.ID != 0)
                    {
                        ...
                        txtNombres.Text = objEmpleado.Nombre;
                        txtApellidos.Text = objEmpleado.ApPaterno + " " + objEmpleado.ApMaterno;
                        txtNroDocumento.Text = objEmpleado.NroDocumento;
                        txtTipoEmpleado.Text = objEmpleado.RTipoEmpleado.Descripcion;
                        txtUsuario.Text = objEmpleado.Usuario;
                    }
                    else
                    {
                        hfIdEmpleado.Value = "0";
